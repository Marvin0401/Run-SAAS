...
const BlockConfigEndorsementsExtra = ({ block }) => {
  ...
  const handleAddItemPress = ({ event, includeImage, key }) => {
    ...
    const updatedItems = [...sharedBlockData?.[key], updatedItem];
...
BlockConfigEndorsementsExtra.propTypes = {
  block: PropTypes.shape(),
};

export default BlockConfigEndorsementsExtra;
